...
url = 'https://www.bellaitalia.co.uk/restaurants/cambridge/leisure-park/menu'
print(f'url: {url}')
html = requests.get(url).text
page = scrapy.Selector(text=html)
menus = page.xpath('//div[@class="k10-menu-selector k10-w-menu-selector k10-menu-selector_carousel_text k10-w-menu-selector_carousel_text"]/div/div[contains(@class,"k10-menu-selector__option")]').getall()

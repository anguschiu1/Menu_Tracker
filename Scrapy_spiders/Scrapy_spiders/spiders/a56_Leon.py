...
class A56LeonSpider(scrapy.Spider):
    ...
    start_urls = ['https://leon.co/menu/all-day/', 'https://leon.co/menu/bits-in-between/','https://leon.co/menu/breakfast/','https://leon.co/menu/coffee/','https://leon.co/menu/drinks/','https://leon.co/menu/kids/']
    ...
    def parse_item(self, response):
        ...
        item_dict = {
            ...
            'allergens': response.xpath('//div[@class="menu-item-allergens"]//div['
                                        '@class="pill  "]/text()').getall(),

...
class A73TopgolfSpider(scrapy.Spider):
    ...
    start_urls = ['https://topgolf.kitchencut.com/ecom/menu-ewrft-copy-6613ff9a4db83']
    ...
    def parse(self, response):
        ...
        for category in categories:
            ...
            headers = category.xpath('.//th[contains(@class,"th")]/text()').getall()[0:14]
            items = category.xpath('.//tr[contains(@class,"jsDish")]')
            for item in items:
                values = item.xpath('./td/text()').getall()[0:14]
